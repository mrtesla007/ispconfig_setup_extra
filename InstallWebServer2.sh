...
InstallWebServer() {
  ...
  if [ "$CFG_WEBSERVER" == "apache" ]; then
	...
	yum -y install httpd24-httpd httpd24-httpd-tools httpd24-libcurl httpd24-libnghttp2 httpd24-runtime rh-php73-php-cli rh-php73-php-common rh-php73-php-json rh-php73-php-pear rh-php73-php-process rh-php73-php-xml rh-php73-php-zip rh-php73-runtime	
	echo -e "[${green}DONE${NC}]\n"
